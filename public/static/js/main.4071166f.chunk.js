(window.webpackJsonp = window.webpackJsonp || []).push([
    [0], { 281: function(e, t, a) { e.exports = a(572) }, 286: function(e, t, a) {}, 568: function(e, t, a) {}, 572: function(e, t, a) { "use strict";
            a.r(t); var n = a(1),
                i = a.n(n),
                r = a(10),
                o = a.n(r),
                ...
                D = function(e) {
                    function t() { var e, a;
                        Object(c.a)(this, t); for (var n = arguments.length, i = new Array(n), r = 0; r < n; r++) i[r] = arguments[r]; return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(i)))).state = { data: [], loading: !1 }, a.fetch = function() { a.setState({ loading: !0 }), fetch("/api/server", { credentials: "include" }).then(function(e) { return e.json() }).then(function(e) { var t = { key: 0, name: "OS", value: e.os.arch + "_" + e.os.platform + "_" + e.os.release },
                                ...
                                a.setState({ loading: !1, data: [t, n, i, r, o, s] }) }).catch(function(e) { a.setState({ loading: !1 }) }) }, a } return Object(m.a)(t, e), Object(d.a)(t, [{ key: "componentDidMount", value: function() { this.fetch() } }, { key: "render", value: function() { return i.a.createElement(b.a, { title: i.a.createElement(n.Fragment, null, i.a.createElement(l.a, { type: "hdd" }), i.a.createElement("span", { style: { paddingLeft: "12px", fontSize: "16px" } }, "Server Info")) }, i.a.createElement(C.a, { dataSource: this.state.data, columns: N, loading: this.state.loading, pagination: !1, showHeader: !1 })) } }]), t }(n.Component),
                T = (a(561), a(277)),
                U = (a(563), a(276)),
                _ = a(178),
                z = function(e) {
                    function t() { var e, a;
                        Object(c.a)(this, t); for (var n = arguments.length, i = new Array(n), r = 0; r < n; r++) i[r] = arguments[r]; return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(i)))).initFlv = function(e) { if (e && _.a.isSupported()) { var t = _.a.createPlayer(Object(E.a)({}, a.props), a.props.config);
                                t.attachMediaElement(e), t.load(), t.play(), a.flvPlayer = t } }, a } return Object(m.a)(t, e), Object(d.a)(t, [{ key: "componentWillUnmount", value: function() { this.flvPlayer && (this.flvPlayer.unload(), this.flvPlayer.detachMediaElement(), this.flvPlayer.destroy()) } }, { key: "render", value: function() { var e = this.props,
                                t = e.className,
                                a = e.style; return i.a.createElement("video", { className: t, style: Object.assign({ width: "100%" }, a), ref: this.initFlv }) } }]), t }(n.Component),
                H = a(278),
                L = a(273),
                F = a.n(L),
                G = function(e) {
                    function t() { var e, a;
                        Object(c.a)(this, t); for (var n = arguments.length, r = new Array(n), o = 0; o < n; o++) r[o] = arguments[o]; return (a = Object(p.a)(this, (e = Object(u.a)(t)).call.apply(e, [this].concat(r)))).cookies = new H.a, a.state = { streamsData: [], loading: !1, visible: !1, password: "" }, a.columns = [{ title: "App", dataIndex: "app", key: "app" }, { title: "Name", dataIndex: "name", key: "name", render: function(e, t) { return i.a.createElement("a", { href: "##", onClick: function() { return a.openVideo(t) } }, e) } }, { title: "ID", dataIndex: "id", key: "id" }, { title: "IP", dataIndex: "ip", key: "ip" }, { title: "Audio", children: [{ title: "codec", dataIndex: "ac", key: "ac" }, { title: "freq", dataIndex: "freq", key: "freq" }, { title: "chan", dataIndex: "chan", key: "chan" }] }, { title: "Video", children: [{ title: "codec", dataIndex: "vc", key: "vc" }, { title: "size", dataIndex: "size", key: "size" }, { title: "fps", dataIndex: "fps", key: "fps" }] }, { title: "Time", dataIndex: "time", key: "time" }, { title: "Clients", dataIndex: "clients", key: "clients" }], a.updatePass = function(e) { var t = e.target.value;
                            a.setState({ password: t }), a.cookies.set("pass", t, { path: "/", maxAge: 31536e3 }) }, a.openVideo = function(e) { var t = ""; if (a.state.password) { var n = F.a.create(),
                                    r = Date.now() + 3e4;
                                n.update("/".concat(e.app, "/").concat(e.name, "-").concat(r, "-").concat(a.state.password)); var o = n.hex();
                                t = "?sign=".concat(r, "-").concat(o) }
                            a.videoModal = U.a.info({ icon: null, title: "Video Player", width: 640, height: 480, content: i.a.createElement(z, { url: "/".concat(e.app, "/").concat(e.name, ".flv").concat(t), type: "flv" }) }) }, a.fetch = function() { a.setState({ loading: !0 }), fetch("/api/streams", { credentials: "include" }).then(function(e) { return e.json() }).then(function(e) { var t = [],
                                    n = 0; for (var i in e)
                                    for (var r in e[i]) { var o = e[i][r].publisher,
                                            s = e[i][r].subscribers; if (o) { var l = (new Date).getTime() / 1e3,
