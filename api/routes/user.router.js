...
router.post("/userdemolist", checkToken, getalldemousers);
router.post("/getproductivity", checkToken, getproductivity);
router.post("/getuserlist", checkToken, getuserlist);
router.post("/getbillingdetail", checkToken, getbillingdetail);
router.post("/gettimeline", checkToken, gettimelineport);
router.post("/getsnapshot", checkToken, getsnapshot);
router.post("/gettaskviewsearch", checkToken, gettaskviewsearch);
...
router.post("/forgotsuccessful", forgotsuccessful);
...
router.post("/getviewdetail", checkToken, getviewdetail);
...
router.post("/companysettingupdatestatus", checkToken, companysettingupdatestatus);
...
router.post("/forgotweb", forgotuserweb);
