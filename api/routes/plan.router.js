const { planlist, planaddservice, planeditservice, planeditshow, planupdatestatus, plandeletesuper, getplanlist, testimoniallist, testimonialaddservice, testimonialupdatestatus, testimonialdeletesuper, testimonialeditshow, testimonialeditservice, gettestimonial, sendmessagelist } = require('../controllers/plan.controller');
...
router.post('/sendmessagelist', checkToken, sendmessagelist);
